...
public class Telephone
{
   ...
   */
   public Telephone()
   {
      ...
      speakerScroll.setVerticalScrollBarPolicy(speakerScroll.VERTICAL_SCROLLBAR_ALWAYS);
      speakerPanel.add(speakerScroll,BorderLayout.CENTER);
      ...
      final JTextArea microphoneField = new JTextArea(10, 25);
      		...
      		microphoneScroll.setVerticalScrollBarPolicy(microphoneScroll.VERTICAL_SCROLLBAR_ALWAYS);
      ...
      microphonePanel.add(new JLabel("Microphone:"),
         BorderLayout.NORTH);
      microphonePanel.add(microphoneScroll,
         BorderLayout.CENTER);
